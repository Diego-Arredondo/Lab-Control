...
cliente.conectar()
#objectNode = cliente.get_objects_node()
#h1 = objectNode.get_child(['1:Proceso Tanques', '1:Tanques','Tanque1','1:h'])
#valor = h1.get_value()
...
while running:
    ...
    if manual:
        ...
        altura = cliente.alturas['H1'].get_value()
        #print(f'La altura del tanque 1 es : {altura}')
